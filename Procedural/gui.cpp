...
NK_API struct nk_context*   gui_init();
NK_API void                 gui_begin();
NK_API void                 gui_end();
...
NK_API struct nk_context* gui_init() {
    ...
    roboto = nk_font_atlas_add_from_file(atlas, "Roboto-Regular.ttf", 16, 0);
...
NK_API void gui_begin() {
    ...
    while (SDL_PollEvent(&evt)) {
        ...
        if (evt.type == SDL_WINDOWEVENT && evt.window.event == SDL_WINDOWEVENT_CLOSE) exit(0);
